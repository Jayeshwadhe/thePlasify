...
function Products() {
  ...
  return (
    <div>
      ...
      {banner && (
        <section
          className="relative h-72 w-[87%] mx-auto bg-cover bg-center flex items-center"
          style={{
            backgroundImage: `url('http://localhost:5000/${banner.backgroundImage.replace(
              "\\",
              "/"
...
{/* Products Content */}
<div className="p-3 space-y-8 w-[80%] mb-16 mx-auto">
  {Array.isArray(products) && products.length > 0 ? (
    ...
    <p className="text-center text-gray-500">No products available</p>
      ...
      {/* Commitment Section */}
      <div className="bg-[#00BFB3] text-white text-center mx-20 py-16">
