    ...
    <>
      <div className="min-h-screen bg-gray-100 px-0 lg:px-20">
        ...
        <div
          ...
          style={{
            // backgroundImage: `url('https://api.theplacify.com/${careerData.headerImage.replace(
            //   "\\",
            //   "/"
            // )}')`,
            ...
            >
              ...
              <div className="h-[90%] w-[90%]">
                <img
                  ...
                  //   "/"
                  // )}`}
                  // src={`https://api.theplacify.com/${section.image.replace("\\", "/")}`}
                  src={CareerImg1}
                  alt={section.title}
      ...
      <div className="w-[100%] mx-auto my-16 bg-gray-100 rounded-sm px-0 lg:px-16">
        ...
        <div className="flex">
          <button
            className={`flex-1 py-2 text-lg font-normal ${selectedTab === "position"
          ...
          <button
            className={`flex-1 py-2 text-lg font-normal ${selectedTab === "benefits"
                ? "bg-gray-100 text-gray-800"
                : "bg-[#00BFB3] text-white"
              }`}
      ...
      <div className="bg-gray-100 pt-10 pb-0 mb-0 px-0 lg:px-20 ">
        ...
        {/* Commitment Section */}
        <div className="bg-[#00BFB3] w-[100%] mx-auto text-white text-center py-16 ">
