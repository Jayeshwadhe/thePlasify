...
function ContactUs() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Call the contact controller API endpoint
      const response = await axios.post("https://api.theplacify.com/api/contact/sendmail", formData);
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <form className="bg-white rounded-lg shadow-lg p-6 space-y-6" onSubmit={handleSubmit}>
            ...
            <button
              ...
              className="bg-teal-500 text-white font-semibold py-2 px-6 rounded-lg hover:bg-teal-600 transition flex items-center justify-center"
            >
              {formSubmitting ? (
                <>
